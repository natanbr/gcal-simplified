...
export function MissionOverlay() {
    ...
    // ── Countdown timer ─────────────────────────────────────────────────────────
    // Uses startedAt + durationMins (set when mission is triggered) rather than
    // the static endsAt HH:MM, so manual triggers work correctly at any time.
    const remainingSecs = (() => {
            ...
            <AnimatePresence>
                {isVisible && meta && mission && (
                    ...
                    >
                        ...
                        {remainingSecs !== null && !timerExpired && (() => {
