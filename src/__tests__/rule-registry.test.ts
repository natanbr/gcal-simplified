...
describe('rule registry', () => {
    ...
    it('does not let the unenforced share of the rulebook grow silently', () => {
        ...
        // Cap is 7 since 2026-09-21, when the TypeScript line was split into one
        // entry per clause. The test-files clause was closed on 2026-09-22 and its
        // slot immediately taken by the root-config clause it was hiding, so the
        // count never moved. Back to 6 once npm run tsc also compiles
