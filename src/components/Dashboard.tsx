...
export const Dashboard: React.FC<DashboardProps> = ({ onLogout, onSwitchToMC }) => {
  ...
  const weekData = useMemo(() => {
    return days.map((day, i) => {
        ...
        // ⚡ Bolt Performance: Partition events in a single pass instead of multiple .filter() calls.
        // This reduces array iterations by 50% for standard grouping operations.
