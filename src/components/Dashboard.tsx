...
export const Dashboard: React.FC<DashboardProps> = ({ onLogout, onSwitchToMC }) => {
  ...
  const eventsByDay = useMemo(() => {
    // ⚡ Bolt Performance: Pre-calculate events per day to avoid O(Days * N) filtering.
    // Grouping into a Map reduces complexity to O(N) and prevents redundant Date object creations per day.
