...
interface MonthlyViewEventItemProps {
    event: AppEvent;
    onEventClick: (event: AppEvent) => void;
}

const MonthlyViewEventItem: React.FC<MonthlyViewEventItemProps> = memo(({ event, onEventClick }) => {
    // ⚡ Bolt Performance: Cache expensive inner calculations using useMemo
...
const MonthlyViewDay: React.FC<MonthlyViewDayProps> = memo(({ day, dayEvents, isToday, isCurrentMonth, onEventClick }) => {
    return (
        <div
